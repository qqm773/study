...
password = "*******"
# 设置要爬取的公众号列表
gzlist = ['凤凰网军事频道'] # '海洋防务前线', '凤凰网军事频道','空天防务观察'
    # 海鹰资讯，桌面战争，知远外军后勤，战略前沿技术
...
def weChat_login():
    ...
    # 等待5秒钟
    time.sleep(5)
    driver.find_element_by_xpath('//*[@id="header"]/div[2]/div/div/div[2]/a[@class="login__type__container__select-type"]').click()
...
def get_content(query):
    ...
    # 登录之后的微信公众号首页url变化为：https://mp.weixin.qq.com/cgi-bin/appmsg?t=media/appmsg_edit_v2&action=edit&isNew=1&type=10&token=1566078309&lang=zh_CN，从这里获取token信息
