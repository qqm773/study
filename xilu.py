...
pas = set()
main_url = ["http://www.xilu.com/","http://junshi.xilu.com/","http://www.xilu.com/sstj/index.html","http://www.xilu.com/jsdt/index.html","http://shizheng.xilu.com/","http://lishi.xilu.com/","http://dili.xilu.com/"]
keyword = ["推荐","军情","战略","武器","国际","历史","台湾"]
...
def main():
    for i in range(0,7):
        savepath = "媒体文章表_分类_" + keyword[i] + "_来源_西陆网.xls"
        datalist = getdata(main_url[i])
